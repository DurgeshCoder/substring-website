          ...
          <div data-aos-delay="100" data-aos="fade-up" class="col-lg-3 card border-0 shadow-lg  m-md-2">
            ...
            <div class="icon flex-shrink-0 m-auto"><i class="bi bi-briefcase"></i></div>
              <div>
                ...
                <p class="description">We are the experts for providing best software development service. .........</p>
              </div>
            </div>
          </div>
          <div data-aos-delay="100" data-aos="fade-up" class="col-lg-3 card border-0 shadow-lg">
      ...
      <div class="icon flex-shrink-0 m-auto"><i class="bi bi-briefcase"></i></div>
        <div>
          ...
          <p class="description">We provide the latest technology and most innovative solutions. Mobile.......</p>
        </div>
      </div>
        ...
        <div class="row gy-4 justify-content-evenly">
          ...
          <div data-aos-delay="100" data-aos="fade-up" class="col-lg-4 card border-0 shadow-lg  ">
            ...
            <div class="icon flex-shrink-0 m-auto " ><img src="Images/lcwd_logo.png " width="60px" ></div>
              <div>
                ...
                <h2 class="description">Learncodewith Durgesh<br>
                                        More than 200K+ Subscriber<br>
                                         More than 2500000+ Views
                                        </h2>
              </div>
              <a href="" class="btn my-4" style="background:#e84545; color:#fff;">Study Online</a>
            </div>
          </div>
          ...
          <div data-aos-delay="100" data-aos="fade-up" class="col-lg-4 card border-0 shadow-lg  ">
            ...
            <div class="icon flex-shrink-0 m-auto " ><img src="Images/lcwd_logo.png " width="60px" ></div>
              <div>
                <h2 class="title"><a class="stretched-link" href="services-details.html"><h1>Learncodewith Durgesh</h1></a></h2>
                <h2 class="description">Thousands of student daily use this resource to sharp their programming skills
                                        </h2>
              </div>
              <a href="" class="btn my-4" style="background:#e84545; color:#fff;">Subscribe</a>
            </div>
          </div>
