      ...
      <div class="container">
        ...
        <div class="row gy-4 justify-content-evenly">
          ...
          <div data-aos-delay="100" data-aos="fade-up" class="col-lg-3 card border-0 shadow-lg  ">
            ...
            <div class="icon flex-shrink-0 m-auto" style="margin-top:-20px;"><img src="images/web-design.png" ></div>
              <div>
          ...
          <div data-aos-delay="100" data-aos="fade-up" class="col-lg-3 card border-0 shadow-lg  m-md-2">
            ...
            <div class="service-item text-center">
            <div class="icon flex-shrink-0 m-auto"><img src="images/android.png" ></div>
              <div>
      ...
      <div class="service-item text-center">
      <div class="icon flex-shrink-0 m-auto"><img src="images/software.png" ></div>
        <div>
          <h4 class="title"><a class="stretched-link" href="services-details.html">Software Training</a></h4>
