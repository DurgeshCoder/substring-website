      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Gallery</h2>
        <p>Exploring the Work: A Creative Journey Through Training</p>
...
<div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
  ...
  <ul class="portfolio-filters isotope-filters" data-aos="fade-up" data-aos-delay="100">
    ...
    <li data-filter=".filter-app">Online Training</li>
    <li data-filter=".filter-branding">Offline Training</li>
    <li data-filter=".filter-product">Certificate Distribution</li>
  ...
  <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
    ...
    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
      <img src="images/online_training/photo_6.jpg" class="img-fluid" alt="">
...
<div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
  <img src="images/online_training/photo_1.jpg" class="img-fluid" alt="">
  <div class="portfolio-info">
    <h4>Online Training</h4>
...
<div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
  <img src="images/online_training/photo_2.jpg" class="img-fluid" alt="">
  <div class="portfolio-info">
    <h4>Online Training</h4>
...
<div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
  <img src="images/online_training/photo_3.jpg" class="img-fluid" alt="">
  <div class="portfolio-info">
    <h4>Online Training</h4>
    ...
    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
      <img src="images/offline_training/photo_6.jpg" class="img-fluid" alt="">
      <div class="portfolio-info">
    ...
    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
      <img src="images/offline_training/photo_1.jpg" class="img-fluid" alt="">
      <div class="portfolio-info">
    ...
    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
      <img src="images/online_training/photo_7.jpg" class="img-fluid" alt="">
      <div class="portfolio-info">
        <h4>Online Training</h4>
    ...
    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
      <img src="images/offline_training/photo_2.jpg" class="img-fluid" alt="">
      <div class="portfolio-info">
        <h4>Certificate Distribution</h4>
    ...
    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
      <img src="images/offline_training/photo_5.jpg" class="img-fluid" alt="">
      <div class="portfolio-info">
        <h4>Offline Training</h4>
    ...
    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
      <img src="images/offline_training/photo_12.jpg" class="img-fluid" alt="">
      <div class="portfolio-info">
        <h4>Certificate Distribution</h4>
    ...
    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
      <img src="images/offline_training/photo_4.jpg" class="img-fluid" alt="">
      <div class="portfolio-info">
        <h4>Offline Training</h4>
    ...
    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
      <img src="images/offline_training/photo_3.jpg" class="img-fluid" alt="">
      <div class="portfolio-info">
        <h4>Offline Training</h4>
    ...
    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
      <img src="images/offline_training/photo_7.jpg" class="img-fluid" alt="">
      <div class="portfolio-info">
        <h4>Offline Training</h4>
    ...
    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
      <img src="images/offline_training/photo_8.jpg" class="img-fluid" alt="">
      <div class="portfolio-info">
        <h4>Offline Training</h4>
    ...
    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
      <img src="images/offline_training/photo_9.jpg" class="img-fluid" alt="">
      <div class="portfolio-info">
        <h4>Offline Training</h4>
    ...
    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
      <img src="images/offline_training/photo_10.jpg" class="img-fluid" alt="">
      <div class="portfolio-info">
        <h4>Offline Training</h4>
    ...
    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
      <img src="images/offline_training/photo_11.jpg" class="img-fluid" alt="">
      <div class="portfolio-info">
        <h4>Offline Training</h4>
